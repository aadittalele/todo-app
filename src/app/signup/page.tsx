  ...
  return (
    <main>
      <div className="mx-auto py-6 md:max-w-xl px-16 text-center">
        ...
        <div className='flex flex-col p-4 w-full mb-2' onSubmit={handleSignup}>
          ...
          <button onClick={handleSignup} className="mt-4 mx-auto text-white w-48 py-1.5 rounded-lg bg-green-600 font-semibold text-xl hover:bg-green-700 transition" type="submit">Sign up</button>
        </div>
        ...
        <Link className="text-blue-400 underline" href="/login">Already have an account? Log in.</Link>
      </div>
    </main>
  );
}